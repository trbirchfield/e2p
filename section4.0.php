...
<head>
	<meta name="description" content="Maintaining fidelity while implementing an evidence-based program increases the likelihood of program success. What factors comprise fidelity? "/>
	<meta name="keywords"    content="program fidelity, assessing program fidelity, aspects of program fidelity"/>
		...
		<div class="row">
			...
			<div class="small-9 columns doc-right">
				...
				<p class="clearfix navigation" id="navigation-bottom">
					<a id="previous" href="/section3.3.php">Previous Section</a>
					<a id="next" href="/section4.1.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section3.3.php"><span>Previous</span>Forming Expectations
						</a>
					</div>
					<div class="next">
						<a href="/section4.1.php"><span>Next</span>Fidelity monitoring
						</a>
					</div>
				</div>
			</div>
