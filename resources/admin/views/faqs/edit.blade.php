				...
				<div class="box box-primary">
					<div class="box-body clearfix">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" name="question" id="question" ng-model="formData.question" ng-init="formData.question = '{{ e(old('question', $resource['question'])) }}'" validation="required">
