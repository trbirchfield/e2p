    ...
    <section class="document-view" ng-controller="AboutController">
        ...
        <div class="row">
            <div class="small-3 columns doc-left">
                ...
                <p>All of the content displayed on this site is owned by the CRC-Senior Health and is protected by copyright laws. You may use, download, reproduce, and publicly display content from this site for personal or noncommercial purposes provided that you attribute the content to the CRC-Senior Health. Community Research Center for Senior Health: Toolkit on Evidence-Based Programming for Seniors. Retrieved DATE (mm/dd/yyyy), from <a href="/home">http://www.evidencetoprograms.com.</a></p>
            </div>
