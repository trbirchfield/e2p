        ...
        <div class="row">
            ...
            <div class="small-9 columns doc-right">
                ...
                <p class="clearfix navigation">
                    <a id="previous" href="/section/2/2">Previous Section</a>
                    <a id="next" href="/section/2/4">Next Section</a>
                </p>
            </div>
        </div>
        <div class="row">
