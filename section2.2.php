...
<head>
	<meta name="description" content="Your audience may have numerous health needs. Which should you address first? This health needs prioritization matrix can help you decide. "/>
	...
	<section class="document-view">
		<div class="row">
			<div class="small-3 columns doc-left">
				<h3>section <span>2.2</span></h3>
			</div>
			<div class="small-9 columns doc-right">
				<h1>Prioritizing needs</h1>
				<p class="clearfix navigation">
					<a id="previous" href="/section2.1.php">Previous Section</a>
					<a id="next" href="/section2.3.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
			<div class="small-3 columns doc-left" id="mid-page5">
		...
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section2.1.php"><span>Previous</span>Identifying an important health issue
						</a>
					</div>
					<div class="next">
						<a href="/section2.3.php"><span>Next</span>Identifying evidence-based interventions
						</a>
					</div>
				</div>
			</div>
