...
<head>
	<meta name="description" content="It is crucial that health promotion programs be evaluated during and after their implementation. Here are the reasons why it is so important."/>
	<meta name="keywords"    content="program evaluation, why conduct program evaluation, reasons for program evaluation"/>
	...
	<section class="document-view">
		<div class="row">
			<div class="small-3 columns doc-left">
				<h3>section <span>3.0</span></h3>
			</div>
			<div class="small-9 columns doc-right">
				<h1>Evaluation planning</h1>
				<p class="clearfix navigation">
					<a id="previous" href="/section2.9.php">Previous Section</a>
					<a id="next" href="/section3.1.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
			<div class="small-3 columns doc-left" id="mid-page8">
				<div class="print-border">
					...
					<p>An introduction to program evaluation of programs for older adults is available on the <a href="/pdfs/EvaluatingEBPrograms_Intro.pdf" target="_blank">National Council on Aging’s website</a>.</p>
		...
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section2.9.php"><span>Previous</span>Obtaining funding
						</a>
					</div>
					<div class="next">
						<a href="/section3.1.php"><span>Next</span>Process evaluation
						</a>
					</div>
				</div>
			</div>
