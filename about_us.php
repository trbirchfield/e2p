	...
	<section class="section-title blue">
		<div class="row">
			<div class="small-12 columns">
				<h1>About the Community Research Center for Senior Health</h1>
			</div>
		</div>
	</section>
	<section class="document-view">
		...
		<div class="row">
			<div class="small-3 columns doc-left">
				...
				<p>All of the content displayed on this site is owned by the CRC-Senior Health and is protected by copyright laws. You may use, download, reproduce, and publicly display content from this site for personal or noncommercial purposes provided that you attribute the content to the CRC-Senior Health.
				Suggested citation: Community Research Center for Senior Health. Toolkit on Evidence-Based Programming for Seniors. Retrieved from URL (add in once domain name is finalized)</p>  
			</div>
