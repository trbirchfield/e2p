...
<head>
	<meta name="description" content="Selecting an evidence-based program that is a good match with your organization’s clientele increases the likelihood of successful program implementation."/>
	<meta name="keywords"    content="evidence-based program match with clientele, evidence-based program match with audience, EBP match with clientele, EBP match with audience"/>
	...
	<section class="document-view">
		<div class="row">
			<div class="small-3 columns doc-left">
				<h3>section <span>2.7</span></h3>
			</div>
			<div class="small-9 columns doc-right">
				<h1>MATCH WITH CLIENTELE</h1>
				<p class="clearfix navigation">
					<a id="previous" href="/section2.6.php">Previous Section</a>
					<a id="next" href="/section2.8.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section2.6.php"><span>Previous</span>Match with organizational resources
						</a>
					</div>
					<div class="next">
						<a href="/section2.8.php"><span>Next</span>Establishing partnerships
						</a>
					</div>
				</div>
			</div>
