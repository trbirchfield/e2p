...
<head>
	<meta name="description" content="Find out the advantages of selecting and implementing evidence-based programs."/>
	<meta name="keywords"    content="advantages of evidence-based programs, benefits of evidence-based programs, advantages of EBPs, benefits of EBPs"/>
		...
		<div class="row">
			...
			<div class="small-9 columns doc-right">
				...
				<p class="clearfix navigation">
					<a id="previous" href="/section1.0.php">Previous Section</a>
					<a id="next" href="/section1.2.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
			...
			<div class="small-9 columns doc-right">
				...
				<ul class="document-list">
					<li><em>Increased likelihood of the program working</em> – You will be implementing a program known to work, as opposed to implementing a program you hope will work.</li>
					<li><em>Efficient use of limited resources</em> – Instead of putting limited resources towards the development of a new program, you can select a previously developed and well-packaged program that is ready for implementation.</li>
					<li><em>Ease of use</em> – The developers of many EBPs have packaged their materials with step-by-step instructions so the programs can be easily implemented in community settings. Moreover, most of these programs come with evaluation materials (surveys, knowledge assessments, etc.) so community organizations are not left having to develop and assess the validity of their own.</li>
					<li><em>Securing funding</em> – The positive outcomes demonstrated in research can help secure funding for EBPs. In fact, many funding agencies and policymakers require that EBPs be implemented with their funding <span class="reference">(see Figure 2 for an example)</span>.</li>
					<li><em>Community buy-in and partnership formation</em> – The demonstrated outcomes of EBPs are attractive to community members and potential partners, facilitating community buy-in and the formation of partnerships.</li>
					<li><em>Advocating for programs</em> – The demonstrated outcomes provide justification when advocating for new programs or when defending existing ones.</li>
					<li><em>Participant preference</em> – Potential participants have become more knowledgeable about health promotion programs and have ongoing access to abundant information regarding these programs via the internet. It is increasingly common for potential participants to seek out or request programs that are evidence-based.</li>
				</ul>
			</div>
		</div>
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section1.0.php"><span>Previous</span>What does it mean for a program to be evidence-based?</a>
					</div>
					<div class="next">
						<a href="/section1.2.php"><span>Next</span>Disadvantages of evidence-based programs
						</a>
					</div>
				</div>
			</div>
