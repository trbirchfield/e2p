...
<head>
	<meta name="description" content="How do evidence-based programs differ from programs that are not evidence-based? These criteria make it easy to understand. "/>
	<meta name="keywords"    content="what makes a program evidence-based, what does it mean for a program to be evidence-based, evidence-based program definition, evidence-based program meaning "/>
	...
	<section class="document-view">
		<div class="row">
			<div class="small-3 columns doc-left">
				<h3>section <span>1.0</span></h3>
			</div>
			<div class="small-9 columns doc-right">
				<h1>What does it mean for a program to be evidence-based?</h1>
				<p class="clearfix navigation">
					<a id="next" href="/section1.1.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
			...
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="next just-next">
						<a href="/section1.1.php"><span>Next</span>Advantages of evidence-based programs
						</a>
					</div>
				</div>
			</div>
