...
<body>
	...
	<header>
		<div class="container">
			<svg width="380" height="102" class="logo no-print">
				<image xlink:href="/images/logo.svg" src="/images/logo.png" width="380" height="102" />
			</svg>
			<img class="logo no-screen" src="/images/logo_small.png" alt="Logo" />
			<nav>
	...
	<div class="pt-wrapper">
		<section id="intro">
			<img class="lt no-print" src="/images/top_left.png" alt="img background">
			<img class="lb no-print" src="/images/bottom_left.png" alt="img background">
			<img class="rt no-print" src="/images/top_right.png" alt="img background">
			<img class="rb no-print" src="/images/bottom_right.png" alt="img background">
			<div class="container">
				<div class="headline">
				...
				<div class="explore">
					<a href="#questions" class="scroll btn">Explore</a>
				</div>
								...
								<div class="middle">
									<div class="section s01 left">
										...
										<div class="entry">
											...
											<ul class="sub-section first-hover">
												<li><a href="/section1.0.php"><span class="s-number">1.0</span><span class="s-title">What does it mean for a program to be evidence-based?</span></a></li>
												<li><a href="/section1.1.php"><span class="s-number">1.1</span><span class="s-title">Advantages of evidence-based programs</span></a></li>
												<li><a href="/section1.2.php"><span class="s-number">1.2</span><span class="s-title">Disadvantages of evidence-based programs</span></a></li>
												<li><a href="/section1.3.php"><span class="s-number">1.3</span><span class="s-title">Organizational readiness to implement evidence-based programs</span></a></li>
											</ul>
										</div>
									</div>
									<div class="section s02 right rev-anim anim">
										...
										<div class="entry">
											...
											<ul class="sub-section first-hover">
												<li><a href="/section2.0.php"><span class="s-number">2.0</span><span class="s-title">Choosing which program to implement</span></a></li>
												<li><a href="/section2.1.php"><span class="s-number">2.1</span><span class="s-title">Identifying an important health issue</span></a></li>
												<li><a href="/section2.2.php"><span class="s-number">2.2</span><span class="s-title">Prioritizing needs</span></a></li>
												<li><a href="/section2.3.php"><span class="s-number">2.3</span><span class="s-title">Identifying evidence-based interventions</span></a></li>
												<li><a href="/section2.4.php"><span class="s-number">2.4</span><span class="s-title">Support from organizational stakeholders and presence of program champions</span></a></li>
												<li><a href="/section2.5.php"><span class="s-number">2.5</span><span class="s-title">Match with organizational purpose</span></a></li>
												<li><a href="/section2.6.php"><span class="s-number">2.6</span><span class="s-title">Match with organizational resources</span></a></li>
												<li><a href="/section2.7.php"><span class="s-number">2.7</span><span class="s-title">Match with clientele</span></a></li>
												<li><a href="/section2.8.php"><span class="s-number">2.8</span><span class="s-title">Establishing partnerships</span></a></li>
												<li><a href="/section2.9.php"><span class="s-number">2.9</span><span class="s-title">Obtaining funding</span></a></li>
											</ul>
										</div>
									</div>
									<div class="section s03 left rev-anim anim">
										...
										<div class="entry">
											...
											<ul class="sub-section first-hover">
												<li><a href="/section3.0.php"><span class="s-number">3.0</span><span class="s-title">Evaluation planning</span></a></li>
												<li><a href="/section3.1.php"><span class="s-number">3.1</span><span class="s-title">Process evaluation</span></a></li>
												<li><a href="/section3.2.php"><span class="s-number">3.2</span><span class="s-title">Impact and outcome evaluation</span></a></li>
												<li><a href="/section3.3.php"><span class="s-number">3.3</span><span class="s-title">Forming expectations</span></a></li>
											</ul>
										</div>
									</div>
									...
									<div class="section s01 left">
										...
										<div class="entry">
											...
											<ul class="sub-section second-hover">
												<li><a href="/section4.0.php"><span class="s-number">4.0</span><span class="s-title">Implementing evidence-based programs with fidelity</span></a></li>
												<li><a href="/section4.1.php"><span class="s-number">4.1</span><span class="s-title">Fidelity monitoring</span></a></li>
												<li><a href="/section4.2.php"><span class="s-number">4.2</span><span class="s-title">Adapting programs to local needs and preferences while maintaining fidelity</span></a></li>
											</ul>
										</div>
									</div>
									<div class="section s02 right rev-anim anim">
										...
										<div class="entry">
											...
											<ul class="sub-section second-hover">
												<li><a href="/section5.0.php"><span class="s-number">5.0</span><span class="s-title">Program marketing and participant recruitment</span></a></li>
												<li><a href="/section5.1.php"><span class="s-number">5.1</span><span class="s-title">Participant retention</span></a></li>
												<li><a href="/section5.2.php"><span class="s-number">5.2</span><span class="s-title">Working with lay leaders</span></a></li>
												<li><a href="/section5.3.php"><span class="s-number">5.3</span><span class="s-title">Sustainability</span></a></li>
												<li><a href="/section5.4.php"><span class="s-number">5.4</span><span class="s-title">Quality assurance</span></a></li>
											</ul>
										</div>
									</div>
