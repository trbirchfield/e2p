...
<head>
	<meta name="description" content="Quality assurance activities ensure that program components are being implemented well. Find out how quality assurance can benefit your program."/>
	<meta name="keywords"    content="quality assurance in health promotion, continuous quality improvement in health promotion, RE-AIM"/>
	...
	<section class="document-view">
		<div class="row">
			<div class="small-3 columns doc-left">
				<h3>section <span>5.4</span></h3>
			</div>
			<div class="small-9 columns doc-right">
				<h1>Quality assurance</h1>
				<p class="clearfix navigation">
					<a id="previous" href="/section5.3.php">Previous Section</a>
				</p>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section5.3.php"><span>Previous</span>Sustainability
						</a>
					</div>
				</div>
			</div>
