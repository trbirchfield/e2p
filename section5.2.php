...
<head>
	<meta name="description" content="Lay leaders are integral components of many evidence-based programs. What traits should you look for in lay leaders and how can lay leaders be recruited?"/>
	<meta name="keywords"    content="lay leaders, recruiting lay leaders, what makes a good lay leader, qualities of good lay leaders"/>
	...
	<section class="document-view">
		<div class="row">
			<div class="small-3 columns doc-left">
				<h3>section <span>5.2</span></h3>
			</div>
			<div class="small-9 columns doc-right">
				<h1>Working with lay leaders</h1>
				<p class="clearfix navigation">
					<a id="previous" href="/section5.1.php">Previous Section</a>
					<a id="next" href="/section5.3.php">Next Section</a>
				</p>
			</div>
		</div>
		<div class="row">
			...
			<div class="small-9 columns doc-right">
				...
				<p>Recruiting lay leaders is often a challenge; recruiting excellent lay leaders is an even bigger challenge. It is best to review your program materials and check with the program developers (if needed) before identifying potential lay leaders. This is because some programs necessitate that lay leaders have specific characteristics. For example, some programs require that lay leaders have chronic diseases similar to those that participants may have. Some programs require lay leaders to complete the program as a participant before they can lead it. Other programs require leaders to have access to a vehicle for transportation to classes.</p>
				<p>Just because an individual has the specific characteristics required to lead a program does not mean he or she will make an excellent leader. Several general qualities that characterize excellent lay leaders are described below.</p>
				<ul class="document-list">
					<li><em>Motivation to help others</em>. Lay leaders should enjoy helping others and desire to see the lives of others improved. This motivation will encourage lay leaders to put a lot of effort into their work and feel like their efforts are valuable.</li>
					<li><em>Commitment to following program protocols</em>. It is very difficult for leaders, both lay and professional, to implement a program without interjecting their own ideas and opinions. However, in the interest of fidelity, it is critical that lay leaders implement the program as designed. Even if lay leaders believe they have useful ideas (such as home remedies or alternative exercises) to supplement those presented in the program, it is important that they present the information they are instructed to in the program materials. Adding to and subtracting from the materials both jeopardize fidelity.</li>
					<li><em>Level of comfort with own disease(s)</em>. If potential lay leaders have a health condition, it is important that they are comfortable with it. Individuals at the extreme ends of the comfort continuum—“victims” who feel depressed and “victors” who want to flaunt their accomplishments—can derail the program by drawing too much focus to themselves. Additionally, individuals at the extremes do not model healthy coping.</li>
					<li><em>Encouraging and non-judgmental personality</em>. Changing behaviors is difficult. Participants join health promotion programs to gain assistance in changing their behaviors. Effective lay leaders can accept participants and their previous behaviors without judgment while providing support and encouragement as they attempt behavior change.</li>
				...
				<ul class="document-list">
					...
					<li>Check with local hospitals about listing the opportunity on their website and posting notices throughout their facilities.
					<li>See if the local chapters of voluntary health organizations (American Heart Association, Alzheimer’s Association, etc.) will include a notice in their newsletters.</li>
					<li>Run an ad in the local newspaper and list the opportunity on Craigslist.</li>
					<li>Mention the opportunity on your organization’s social media pages.</li>
					<li>Consider people you already know. Do you have a neighbor, fellow church member, or workout buddy who might make a good lay leader? Ask him or her if the opportunity is of interest.</li>
					<li>Contact your partners to see if they know individuals who might make good lay leaders.</li>
					<li>After you begin offering the program, ask your leaders to identify participants who might make good lay leaders. Check with them to see if they would be interested in the opportunity.</li>
				</ul>
			</div>
		</div>
		<div class="row">
			<div class="small-12 columns">
				<div class="document-nav">
					<div class="previous">
						<a href="/section5.1.php"><span>Previous</span>Participant retention
						</a>
					</div>
					<div class="next">
						<a href="/section5.3.php"><span>Next</span>Sustainability
						</a>
					</div>
				</div>
			</div>
